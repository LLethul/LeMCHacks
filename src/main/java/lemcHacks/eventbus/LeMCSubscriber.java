...
public class LeMCSubscriber {
    ...
    public LeMCSubscriber(Object target, String methodName, Class<? extends Event> eventClass) {
        this(target, MethodUtils.getAccessibleMethod(target.getClass(), methodName, eventClass), eventClass);
    }

    public LeMCSubscriber(Object target, Method method) {
        this(target, method, getEvent(method));
    }

    public LeMCSubscriber(Object target, Method method, Class<? extends Event> eventClass) {
        try {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof LeMCSubscriber) {
            LeMCSubscriber that = (LeMCSubscriber) obj;
