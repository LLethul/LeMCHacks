package lemcHacks.util.render;

import com.mojang.blaze3d.systems.RenderSystem;
import lemcHacks.util.render.color.LineColor;
import lemcHacks.util.render.color.QuadColor;
import lemcHacks.util.Boxes;
...
public class Renderer {
    ...
    public static void drawBoxFill(Box box, QuadColor color, Direction... excludeDirs) {
        if (!FrustumUtil.isBoxVisible(box)) {
            return;
        }
    ...
    public static void drawQuadFill(double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3, double x4, double y4, double z4, int cullMode, QuadColor color) {
        if (!FrustumUtil.isPointVisible(x1, y1, z1) && !FrustumUtil.isPointVisible(x2, y2, z2)
                && !FrustumUtil.isPointVisible(x3, y3, z3) && !FrustumUtil.isPointVisible(x4, y4, z4)) {
            return;
        }
