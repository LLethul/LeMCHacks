...
public class WorldUtil {
    ...
    public static boolean placeBlock(BlockPos pos, int slot, boolean forceLegit, boolean airPlace, boolean swingHand) {
        return placeBlock(pos, slot, 0, forceLegit, airPlace, swingHand);
    }
    ...
    public static boolean placeBlock(BlockPos pos, int slot, int rotateMode, boolean forceLegit, boolean airPlace, boolean swingHand) {
        ...
        for (Direction d : Direction.values()) {
            ...
            Hand hand = InventoryUtil.selectSlot(slot);
